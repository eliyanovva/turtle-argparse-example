"""This module contains the Argument Parser object with the expected arguments for drawing.
"""
import argparse

class DrawingParser(argparse.ArgumentParser):
    """This class specifies the Argument Parser which requests for the needed elements
    in drawing the regular polygon.
    """
    def __init__(self):
        super().__init__(
    ...
    def setup_arguments(self):
        ...
        self.add_argument(
            '--length',
            help = 'Sets the length of the side of a shape to a custom value.',
            type = int
        )
        self.add_argument(
